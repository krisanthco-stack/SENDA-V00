...
El repositorio incluye `index.html` en la raíz y `.nojekyll`, por lo que GitHub Pages abre directamente la interfaz de SENDA.V0 en lugar de renderizar el README. En Pages se muestra una **vista web** de la interfaz; la importación, SQLite y los expedientes requieren ejecutar el servidor local con `INICIAR_SENDA_V0.bat`.
