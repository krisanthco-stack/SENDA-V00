...
COLS=['folio','derecho','plano','fecha','codigo','operacion','categoria','tipo','fuente','cedula','titular','anio','mes','trimestre','distrito','archivo_origen','alarma','case_id','estado_expediente','en_control','en_gestion']
